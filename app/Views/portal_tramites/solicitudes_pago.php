                                ...
                                <tr class="text-center">
                                    <td>
                                        <div class="btn-group btn-group-xs">
                                            <?php if ($r["status"] == 0) { ?>
                                                <a href="<?= base_url("portal_tramites/subir_documentacion_solicitud_pago") . "?data=" . $r["id_tramite_solicitud_pago"] ?>" title="Subir documentación" class="btn btn-setab2"><i class='bx bx-cloud-upload'></i></a>
