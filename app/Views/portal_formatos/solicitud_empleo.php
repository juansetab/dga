<link rel="stylesheet" href="<?= base_url("public/library/multiselect/multiselect.css") ?>" />
<div class="row">
                        ...
                        <div class="accordion-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="salud_edo_salud" name="salud_edo_salud">
                                        <option value="">SELECCIONE UNA OPCION</option>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="salud_enfermedad" name="salud_enfermedad">
                                        <option value="">SELECCIONE UNA OPCION</option>
                                        <option value="SI">SI</option>
                                        <option value="NO">NO</option>
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="salud_deporte" name="salud_deporte">
                                        <option value="">SELECCIONE UNA OPCION</option>
                                        <option value="SI">SI</option>
                                        <option value="NO">NO</option>
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="salud_club" name="salud_club">
                                        <option value="">SELECCIONE UNA OPCION</option>
                                        <option value="SI">SI</option>
                                        <option value="NO">NO</option>
                                    </select>
                        ...
                        <div class="accordion-body">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="escolar_profesional_titulo" name="escolar_profesional_titulo">
                                        <option value="">SELECCIONE UNA OPCION</option>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    <label>Título recibido:</label>
                                    <select class="form-select form-select-sm" id="escolar_otras_titulo" name="escolar_otras_titulo">
                                        <option value="">SELECCIONE UNA OPCION</option>
                        ...
                        <div class="accordion-body">
                            <div class="row">
                                ...
                                <div id="select_idiomas_habla" class="col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <fieldset>
                                        <details>
                                            <summary class="form-select form-select-sm" style="width:100%;">Selecciona una o varias opciones</summary>
                                            <ul>
                                                <li>
                                                    <label> <input type="checkbox" name="select_idiomas_habla_ninguno" id="select_idiomas_habla_ninguno" value="NINGUNO" /> NINGUNO</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="select_idiomas_habla_ingles" id="select_idiomas_habla_ingles" value="INGLES" /> INGLES</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="select_idiomas_habla_frances" id="select_idiomas_habla_frances" value="FRANCES" /> FRANCES</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="select_idiomas_habla_italiano" id="select_idiomas_habla_italiano" value="ITALIANO" /> ITALIANO</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="select_idiomas_habla_chino" id="select_idiomas_habla_chino" value="CHINO" /> CHINO</label>
                                                </li>
                                            </ul>
                                        </details>
                                    </fieldset>
                                ...
                                <div id="select_conocimientos_funciones" class="col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <fieldset>
                                        <details>
                                            ...
                                            <ul>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_funciones_select_ninguna" id="conocimientos_funciones_select_ninguna" value="NINGUNA" /> NINGUNA</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_funciones_administrativo" id="conocimientos_funciones_administrativo" value="ADMINISTRATIVO" /> ADMINISTRATIVO</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_funciones_redaccion" id="conocimientos_funciones_redaccion" value="REDACCION" /> REDACCION</label>
                                                </li>
                                            </ul>
                                        </details>
                                    </fieldset>
                                ...
                                <div id="select_conocimientos_software" class="col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    <fieldset>
                                        <details>
                                            ...
                                            <ul>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_ninguno" id="conocimientos_software_select_ninguno" value="NINGUNO" /> NINGUNO</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_word" id="conocimientos_software_select_word" value="WORD" /> WORD</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_excel" id="conocimientos_software_select_excel" value="EXCEL" /> EXCEL</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_powerpoint" id="conocimientos_software_select_powerpoint" value="POWER POINT" /> POWER POINT</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_autocad" id="conocimientos_software_select_autocad" value="AUTOCAD" /> AUTOCAD</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_ilustrator" id="conocimientos_software_select_ilustrator" value="ILUSTRATOR" /> ILUSTRATOR</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_classrom" id="conocimientos_software_select_classrom" value="CLASSROOM" /> CLASSROOM</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_photoshop" id="conocimientos_software_select_photoshop" value="PHOTOSHOP" /> PHOTOSHOP</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_revit" id="conocimientos_software_select_revit" value="REVIT" /> REVIT</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_zoom" id="conocimientos_software_select_zoom" value="ZOOM" /> ZOOM</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_meet" id="conocimientos_software_select_meet" value="GOOGLE MEET" /> GOOGLE MEET</label>
                                                </li>
                                                <li>
                                                    <label> <input type="checkbox" name="conocimientos_software_select_adobe" id="conocimientos_software_select_adobe" value="ADOBE" /> ADOBE</label>
                                                </li>
                                            </ul>
                                        </details>
                                    </fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="input-group  input-group-sm">
                                        <select class="form-select form-select-sm" id="empleo_ultimo1_informes_sino" name="empleo_ultimo1_informes_sino">
                                            <option value="">SELECCIONE UNA OPCION</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <label>¿Podemos solicitar informes de usted? ¿Por qué?:</label>
                                    <div class="input-group  input-group-sm">
                                        <select class="form-select form-select-sm" id="empleo_ultimo2_informes_sino" name="empleo_ultimo2_informes_sino">
                                            <option value="">SELECCIONE UNA OPCION</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    <label>¿Podemos solicitar informes de usted? ¿Por qué?:</label>
                                    <div class="input-group  input-group-sm">
                                        <select class="form-select form-select-sm" id="empleo_ultimo3_informes_sino" name="empleo_ultimo3_informes_sino">
                                            <option value="">SELECCIONE UNA OPCION</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                        ...
                        <div class="accordion-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="general_supo_empleo" name="general_supo_empleo">
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="general_parientes" name="general_parientes">
                                        <option value="" selected>SELECCIONE UNA OPCION</option>
                                        <option value="SI">SI</option>
                                        <option value="NO">NO</option>
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="general_sindicato" name="general_sindicato">
                                        <option value="" selected>SELECCIONE UNA OPCION</option>
                                        <option value="SI">SI</option>
                                        <option value="NO">NO</option>
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="general_horario" name="general_horario">
                                        <option value="" selected>SELECCIONE UNA OPCION</option>
                                        <option value="SI">SI</option>
                                        <option value="NO">NO</option>
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="general_traslado" name="general_traslado">
                                        <option value="" selected>SELECCIONE UNA OPCION</option>
                                        <option value="SI">SI</option>
                                        <option value="NO">NO</option>
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="general_viajar" name="general_viajar">
                                        <option value="" selected>SELECCIONE UNA OPCION</option>
                                        <option value="SI">SI</option>
                                        <option value="NO">NO</option>
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    ...
                                    <select class="form-select form-select-sm" id="general_residencia" name="general_residencia">
                                        <option value="" selected>SELECCIONE UNA OPCION</option>
                                        <option value="SI">SI</option>
                                        <option value="NO">NO</option>
                                    </select>
                        ...
                        <div class="accordion-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="input-group  input-group-sm">
                                        <select class="form-select form-select-sm" id="economico_ingresos_sino" name="economico_ingresos_sino">
                                            <option value="" selected>SELECCIONE UNA OPCION</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="input-group  input-group-sm">
                                        <select class="form-select form-select-sm" id="economico_conyugue_sino" name="economico_conyugue_sino">
                                            <option value="" selected>SELECCIONE UNA OPCION</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="input-group  input-group-sm">
                                        <select class="form-select form-select-sm" id="economico_casa_sino" name="economico_casa_sino">
                                            <option value="" selected>SELECCIONE UNA OPCION</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="input-group  input-group-sm">
                                        <select class="form-select form-select-sm" id="economico_renta_sino" name="economico_renta_sino">
                                            <option value="" selected>SELECCIONE UNA OPCION</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
                                ...
                                <div class="col-sm-12 col-md-3 col-lg-3">
                                    ...
                                    <select class="form-select form-select-sm" id="economico_coche_sino" name="economico_coche_sino">
                                        <option value="" selected>SELECCIONE UNA OPCION</option>
                                        <option value="SI">SI</option>
                                        <option value="NO">NO</option>
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-6">
                                    ...
                                    <div class="input-group input-group-sm">
                                        <select class="form-select form-select-sm" id="economico_deudas_sino" name="economico_deudas_sino">
                                            <option value="" selected>SELECCIONE UNA OPCION</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                                        </select>
...
<div class="text-center">
    <button type="button" class="btn btn-setab1" onclick="sendData()">Generar</button>
</div>

<script src="<?= base_url("public/library/multiselect/multiselect.js") ?>"></script>
<script>
        ...
        document.querySelectorAll("input, select").forEach(function(current) {
            if (window.localStorage.getItem(current.id) !== null) {
                if (current.type != "checkbox") {
                    ...
                    if (window.localStorage.getItem(current.id) == "checked") {
                        current.checked = true;
                    } else {
                        current.checked = false;
                    }
                    //console.log(current.id, window.localStorage.getItem(current.id), current.checked);
                }
            }
        });
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (validateData()) {
                    ...
                    form.action = '<?= base_url("portal_formatos/genera_solicitud_empleo_estatal") ?>';
                    form.method = 'POST';
                    form.target = '_blank';
                    form.submit();
                }
    ...
    function multiselectToText(multiselectDiv, input) {
        array = [];
        document.querySelectorAll(`#${multiselectDiv} input`).forEach((checkbox) => {
            if (checkbox.checked) {
